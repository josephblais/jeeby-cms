"use client";
import React, { forwardRef, createContext, useContext, useMemo, useState, useRef, useEffect, useCallback, Fragment as Fragment$2, useDebugValue, useLayoutEffect } from 'react';
import { useCMSFirebase, useAuth } from 'jeeby-cms';
import { getDoc, updateDoc, serverTimestamp, collection, getDocs, doc, setDoc, deleteDoc } from 'firebase/firestore';
...
function EditorHeader({ pageName, slug, saveStatus, onRetry, onBackClick, onRenameSlug }) {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "jeeby-cms-editor-header", style: {
    display: "flex",
    alignItems: "center",
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }, children: [
      /* @__PURE__ */ jsx("h1", { className: "jeeby-cms-editor-title", style: { margin: 0 }, children: pageName || slug }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
        ...
        slugDirty && /* @__PURE__ */ jsx("span", { className: "jeeby-cms-slug-hint", "aria-live": "polite", children: "Press Enter to rename" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        "aria-atomic": "true",
        children: [
          saveStatus === "saving" && /* @__PURE__ */ jsx("span", { children: "Saving..." }),
          saveStatus === "saved" && /* @__PURE__ */ jsx("span", { children: "Saved" }),
          saveStatus === "error" && /* @__PURE__ */ jsxs("span", { children: [
            "Save failed.",
            " ",
            /* @__PURE__ */ jsx(
              "button",
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: [
    /* @__PURE__ */ jsx(
      "select",
      {
        ...
        children: LEVELS.map((l) => /* @__PURE__ */ jsx("option", { value: l, children: l.toUpperCase() }, l))
      }
    ),
    /* @__PURE__ */ jsx(
      "div",
...
var ToolbarButton = ({ label, isActive: isActive2, onClick }) => /* @__PURE__ */ jsx(
  "button",
  {
    type: "button",
    "aria-label": label,
...
function ImageEditor({ data, onChange, blockId }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("p", { id: "alt-hint-" + blockId, children: "Describe the image for screen readers" })
    ] }),
    (data == null ? void 0 : data.src) && !imgError && /* @__PURE__ */ jsx("figure", { style: { margin: 0 }, children: /* @__PURE__ */ jsx(
      "img",
      {
        src: data.src,
    ...
    (data == null ? void 0 : data.src) && imgError && /* @__PURE__ */ jsx("div", { children: "Image not found. Check that the URL is correct and publicly accessible." })
  ] });
}
...
function VideoEditor({ data, onChange, blockId }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: [
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("p", { children: "YouTube, Vimeo, or Loom URLs are supported" }),
      showError && /* @__PURE__ */ jsx("p", { role: "alert", children: "Unrecognised video URL" })
    ] }),
    embedUrl && isRecognized && /* @__PURE__ */ jsx("div", { style: { aspectRatio: "16/9", width: "100%" }, children: /* @__PURE__ */ jsx(
      "iframe",
      {
        title: "Video preview",
        src: embedUrl,
...
function GalleryEditor({ data, onChange, blockId }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: [
    /* @__PURE__ */ jsx("ol", { "aria-label": "Gallery images", style: { listStyle: "none", padding: 0, margin: 0 }, children: items.map((item, index) => /* @__PURE__ */ jsxs("li", { style: {
      display: "flex",
      gap: "8px",
      ...
      /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: "4px" }, children: [
        /* @__PURE__ */ jsx(
          "input",
          {
...
function BlockTypePicker({ onSelect, onClose }) {
  ...
  return /* @__PURE__ */ jsx(
    "ul",
    {
      ...
      children: BLOCK_TYPES.map((bt, index) => /* @__PURE__ */ jsx(
        "li",
        {
          role: "option",
          tabIndex: 0,
...
function AddBlockButton({ onAdd, insertIndex }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "center", position: "relative" }, children: [
    /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: "50%", left: 0, right: 0, height: "1px" } }),
    /* @__PURE__ */ jsx(
      "button",
      {
        ref: buttonRef,
...
function BlockCanvas({ blocks, onReorder, onChange, onDelete, onAddBlock }) {
  if (blocks.length === 0) {
    return /* @__PURE__ */ jsx("div", { className: "jeeby-cms-block-canvas", style: { maxWidth: "720px", margin: "0 auto" }, children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("p", { children: "No blocks yet" }),
      /* @__PURE__ */ jsx("p", { children: "Click + to add your first block." }),
      /* @__PURE__ */ jsx(AddBlockButton, { onAdd: (type) => onAddBlock(type, -1), insertIndex: -1 })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-block-canvas", style: { maxWidth: "720px", margin: "0 auto" }, children: [
    /* @__PURE__ */ jsx(AddBlockButton, { onAdd: (type) => onAddBlock(type, -1), insertIndex: -1 }),
    /* @__PURE__ */ jsx(
      Reorder.Group,
      {
...
function PageEditor({ slug }) {
  ...
  function handleDelete2(block) {
    ...
    deleteTimerRef.current = setTimeout(() => {
      saveDraft(db, slug, blocksRef.current.filter((b) => b.id !== block.id)).catch(() => setSaveStatus("error"));
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("div", { className: "jeeby-cms-page-editor", children: /* @__PURE__ */ jsx("div", { role: "status", "aria-label": "Loading editor", style: { display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ jsx("div", { "aria-hidden": "true", style: {
      width: "32px",
      height: "32px",
      animation: "jeeby-spin 0.75s linear infinite"
    } }) }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-page-editor", children: [
    /* @__PURE__ */ jsx(
      EditorHeader,
      {
        pageName,
    ...
    /* @__PURE__ */ jsx("div", { className: "jeeby-cms-editor-main", style: { minHeight: "calc(100vh - 120px)" }, children: /* @__PURE__ */ jsx(
      BlockCanvas,
      {
        blocks,
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsx("main", { className: "jeeby-cms-login-page", role: "main", children: /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-login-card", style: {
    ...
    /* @__PURE__ */ jsx("h1", { className: "jeeby-cms-login-heading", children: "jeeby CMS" }),
    /* @__PURE__ */ jsxs("form", { className: "jeeby-cms-login-form", onSubmit: handleSubmit, noValidate: true, children: [
      /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-field", children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "cms-email", style: { display: "block" }, children: "Email address" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            id: "cms-email",
      ...
      /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-field", children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "cms-password", style: { display: "block" }, children: "Password" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            id: "cms-password",
...
function AdminNav({ onSignOut }) {
  return /* @__PURE__ */ jsxs("header", { className: "jeeby-cms-nav", role: "banner", style: {
    ...
    /* @__PURE__ */ jsx("span", { className: "jeeby-cms-nav-brand", children: "jeeby CMS" }),
...
function CreatePageModal({ open, onClose, onCreated, triggerRef }) {
  ...
  if (!open) return null;
  return /* @__PURE__ */ jsx("div", { className: "jeeby-cms-modal-backdrop", style: {
    position: "fixed",
    inset: 0,
    display: "flex",
    alignItems: "center",
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, noValidate: true, children: [
          /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-field", children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "cms-page-name", style: { display: "block" }, children: "Page name" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "cms-page-name",
          ...
          /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-field", children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "cms-page-slug", style: { display: "block" }, children: "Slug" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "cms-page-slug",
          ...
          templates.length > 0 && /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-field", children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "cms-page-template", style: { display: "block" }, children: "Template" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "flex-end", gap: "16px" }, children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
...
function PageManager() {
  ...
  if (loading && pages.length === 0) {
    return /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-page-manager", children: [
      ...
      /* @__PURE__ */ jsx("div", { role: "status", "aria-label": "Loading pages", style: {
        display: "flex",
        justifyContent: "center"
      }, children: /* @__PURE__ */ jsx("div", { "aria-hidden": "true", style: {
        width: "32px",
        height: "32px",
        animation: "jeeby-spin 0.75s linear infinite"
      } }) })
  ...
  if (pages.length === 0 && !loading) {
    return /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-page-manager", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-pages-empty", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "Create your first page." }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ref: newPageBtnRef,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-page-manager", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "jeeby-cms-page-list-header", style: {
      display: "flex",
      justifyContent: "space-between",
      alignItems: "center"
    }, children: [
    ...
    /* @__PURE__ */ jsxs("table", { className: "jeeby-cms-pages-table", style: { width: "100%", borderCollapse: "collapse" }, children: [
      ...
      /* @__PURE__ */ jsx("tbody", { children: pages.map((page) => /* @__PURE__ */ jsxs(Fragment$2, { children: [
