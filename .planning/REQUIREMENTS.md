...
- [ ] **AUTH-02**: `withCMSAuth` middleware helper redirects unauthenticated requests away from `/admin/*`
- [ ] **AUTH-03**: `useAuth` hook exposes current user and sign-out function to admin components
...
- [ ] **EDIT-01**: Admin can view and edit blocks on a page in a drag-and-drop canvas
- [ ] **EDIT-02**: Admin can add a new block of any supported type via `BlockToolbar`
...
- [ ] **MEDIA-01**: Video editor supports embed URL input (YouTube, Vimeo, Loom) and generates iframe src
